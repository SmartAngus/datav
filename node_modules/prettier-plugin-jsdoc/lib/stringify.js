...
const stringify = ({ name, description, type, tag }, tagIndex, finalTagsArray, options, maxTagTitleLength, maxTagTypeNameLength, maxTagNameLength) => {
    ...
    if (tag === tags_1.EXAMPLE && !tsdoc) {
        ...
        const formattedExample = (0, utils_1.formatCode)(description, beginningSpace, options);
        ...
        if (roles_1.TAGS_PEV_FORMATE_DESCRIPTION.includes(tag) ||
            ...
            if ((tag !== tags_1.DESCRIPTION &&
                ...
                tagString +=
                    `\n${beginningSpace}` +
                        (0, descriptionFormatter_1.formatDescription)(tag, description, options, { beginningSpace });
            }
            else {
                // append the description to the tag
                tagString += (0, descriptionFormatter_1.formatDescription)(tag, description, options, {
    ...
    tagString += (0, descriptionFormatter_1.descriptionEndLine)({
        tag,
