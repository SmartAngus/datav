...
var TabHeader = React.forwardRef(function (props, ref) {
    ...
    var _f = __read(useState(true), 2), shouldScroll = _f[0], setShouldScroll = _f[1];
    ...
    var renderAddIcon = function (isEditable) {
        return (isEditable &&
            showAddButton && (React.createElement("div", { className: prefixCls + "-add-icon", onClick: handleAdd }, addButton || (React.createElement(IconHover, { prefix: prefixCls + "-add" },
