...
var UsedDraggableGroup = function (_a) {
    ...
    return draggable ? (React.createElement(Draggable, { itemWrapperStyle: { display: 'inline-block' }, direction: "horizontal", onIndexChange: onIndexChange }, children)) : (React.createElement(React.Fragment, null, children));
};
...
function InputTag(baseProps, ref) {
    ...
    return (React.createElement("div", __assign({}, pickTriggerPropsFromRest(props), { style: style, className: cs(prefixCls, (_a = {},
        ...
        React.createElement("div", { className: prefixCls + "-view" },
            React.createElement(UsedTransitionGroup, { prefixCls: prefixCls, animation: animation },
                React.createElement(UsedDraggableGroup, { draggable: draggable, onIndexChange: function (index, prevIndex) {
