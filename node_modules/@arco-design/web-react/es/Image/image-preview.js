...
function Preview(props, ref) {
    ...
    var className = props.className, style = props.style, src = props.src, defaultVisible = props.defaultVisible, _c = props.maskClosable, maskClosable = _c === void 0 ? true : _c, _d = props.closable, closable = _d === void 0 ? true : _d, _e = props.breakPoint, breakPoint = _e === void 0 ? 316 : _e, actions = props.actions, _f = props.actionsLayout, actionsLayout = _f === void 0 ? [
        ...
        'originalSize',
        'extra',
    ] : _f, _g = props.getPopupContainer, getPopupContainer = _g === void 0 ? function () { return document.body; } : _g, onVisibleChange = props.onVisibleChange, _h = props.escToExit, escToExit = _h === void 0 ? true : _h;
    var _j = useContext(PreviewGroupContext), previewGroup = _j.previewGroup, previewUrlMap = _j.previewUrlMap, currentId = _j.currentId, setCurrentId = _j.setCurrentId, infinite = _j.infinite;
    ...
    var _k = __read(useMergeValue(false, {
        defaultValue: defaultVisible,
        value: props.visible,
    }), 2), visible = _k[0], setVisible = _k[1];
    var _l = useContext(ConfigContext), getPrefixCls = _l.getPrefixCls, locale = _l.locale;
    ...
    var _m = useImageStatus('loading'), isLoading = _m.isLoading, isLoaded = _m.isLoaded, setStatus = _m.setStatus;
    var _o = __read(useState(false), 2), toolbarSimple = _o[0], setToolbarSimple = _o[1];
    var _p = __read(useState({ x: 0, y: 0 }), 2), translate = _p[0], setTranslate = _p[1];
    var _q = __read(useState(1), 2), scale = _q[0], setScale = _q[1];
    var _r = __read(useState(false), 2), scaleValueVisible = _r[0], setScaleValueVisible = _r[1];
    var _s = __read(useState(0), 2), rotate = _s[0], setRotate = _s[1];
    var _t = __read(useState(false), 2), moving = _t[0], setMoving = _t[1];
    // Reset image params
    function reset() {
    ...
    var _u = __read(useState(), 2), container = _u[0], setContainer = _u[1];
    ...
    function onZoomIn() {
        var newScale = getScale(scale, 'zoomIn');
        onScaleChange(newScale);
    }
    function onZoomOut() {
        var newScale = getScale(scale, 'zoomOut');
        onScaleChange(newScale);
    }
    ...
    return (React.createElement(Portal, { visible: visible, forceRender: false, getContainer: getContainer },
        React.createElement(ConfigProvider, { getPopupContainer: function () { return refWrapper.current; } },
            React.createElement("div", { className: classNames, style: __assign(__assign({}, (style || {})), (isFixed ? {} : { zIndex: 'inherit', position: 'absolute' })) },
                ...
                visible && (React.createElement(ResizeObserver, { onResize: onWrapperResize },
                    React.createElement("div", { ref: refWrapper, className: previewPrefixCls + "-wrapper", onClick: onOutsideImgClick },
                        ...
                        previewGroup && (React.createElement(ImagePreviewArrow, { previewCount: previewUrlIdList.length, current: currentIndex, infinite: infinite, onPrev: onPrev, onNext: onNext })))))))));
}
