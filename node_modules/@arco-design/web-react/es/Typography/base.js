...
function Base(props) {
    ...
    function calcEllipsis() {
        ...
        if (ellipsisConfig.rows) {
            ...
            setMeasuring(true);
            var _a = measure(componentRef.current, ellipsisConfig, renderOperations(!!ellipsisConfig.expandable), children, simpleEllipsis), ellipsis_1 = _a.ellipsis, text = _a.text;
            setMeasuring(false);
            if (ellipsis_1 && text) {
    ...
    function renderContent() {
        ...
        var node = (React.createElement(TextComponent, __assign({ className: cs(prefixCls, (_a = {}, _a[prefixCls + "-simple-ellipsis"] = simpleEllipsis, _a), componentClassName, className) }, baseProps, omit(rest, [
            'spacing',
            'type',
            'close',
            'bold',
