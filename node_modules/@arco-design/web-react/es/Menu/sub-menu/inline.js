...
var SubMenuInline = function (props) {
    ...
    var _b = useContext(MenuContext), prefixCls = _b.prefixCls, levelIndent = _b.levelIndent, _c = _b.openKeys, openKeys = _c === void 0 ? [] : _c, _d = _b.selectedKeys, selectedKeys = _d === void 0 ? [] : _d, icons = _b.icons, onClickSubMenu = _b.onClickSubMenu, onClickMenuItem = _b.onClickMenuItem, collectInlineMenuKeys = _b.collectInlineMenuKeys;
    ...
    var header = (React.createElement("div", { className: cs(baseClassName + "-header", (_a = {},
    ...
    var content = (React.createElement("div", { className: cs(baseClassName + "-content"), style: { height: height } }, childrenList));
