...
var useResizeObserver_1 = __importDefault(require("../_util/hooks/useResizeObserver"));
...
function Base(props) {
    ...
    var ellipsisConfig = ellipsis
        ? __assign({ rows: 1, ellipsisStr: '...', cssEllipsis: true }, ((0, is_1.isObject)(ellipsis) ? ellipsis : {})) : {};
    ...
    var _g = (0, useResizeObserver_1.default)(resizeOnNextFrame), cor = _g.cor, dor = _g.dor, currentOr = _g.currentOr;
    ...
    function calcEllipsis() {
        ...
        if (ellipsisConfig.rows) {
            ...
            setMeasuring(true);
            var _a = (0, utils_1.measure)(componentRef.current, ellipsisConfig, renderOperations(!!ellipsisConfig.expandable), children, simpleEllipsis), ellipsis_1 = _a.ellipsis, text = _a.text;
            setMeasuring(false);
            if (ellipsis_1 && text) {
    ...
    function renderContent() {
        ...
        function renderInnerContent() {
            ...
            return (react_1.default.createElement(react_1.default.Fragment, null,
                addTooltip ? react_1.default.createElement("span", null, innerText) : innerText,
        ...
        var node = (react_1.default.createElement(TextComponent, __assign({ className: (0, classNames_1.default)(prefixCls, (_a = {}, _a[prefixCls + "-simple-ellipsis"] = simpleEllipsis, _a), componentClassName, className) }, baseProps, (0, omit_1.default)(rest, [
            'spacing',
            'type',
            'close',
            'bold',
        ...
        if (addTooltip) {
            return (react_1.default.createElement(TooltipComponent, __assign({ content: fullText }, tooltipProps), node));
        }
        return node;
    }
