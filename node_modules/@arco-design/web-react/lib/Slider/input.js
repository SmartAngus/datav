...
var Input = function (props) {
    var _a;
    var value = props.value, range = props.range, min = props.min, max = props.max, step = props.step, disabled = props.disabled, prefixCls = props.prefixCls, onChange = props.onChange;
    var inputProps = {
        min: min,
        max: max,
        step: step,
    ...
    var _b = __read((0, react_1.useState)(value), 2), innerValue = _b[0], setInnerValue = _b[1];
    ...
    return (react_1.default.createElement("div", { className: (0, classNames_1.default)(prefixCls + "-input", (_a = {}, _a[prefixCls + "-input-group"] = range, _a)), onBlur: handleBlur },
        range && [
            react_1.default.createElement(InputNumber_1.default, __assign({ value: innerValue[0], key: 0 }, inputProps, { onChange: function (val) {
        ...
        react_1.default.createElement(InputNumber_1.default, __assign({ key: 2, value: innerValue[1] }, inputProps, { onChange: function (val) {
