...
function List(baseProps, ref) {
    ...
    var renderList = function () {
        ...
        return (react_1.default.createElement("div", { ref: function (_ref) {
            ...
            react_1.default.createElement("div", { style: style, className: (0, classNames_1.default)(prefixCls, prefixCls + "-" + size, (_a = {},
                ...
                isVirtual ? (react_1.default.createElement(react_1.default.Fragment, null,
                    react_1.default.createElement(VirtualList_1.default, __assign({ ref: function (ref) {
                            if (ref) {
                                refVirtualList.current = ref;
                                refScrollElement.current = ref.dom;
                            }
                        }, className: prefixCls + "-content " + prefixCls + "-virtual", data: listItems, isStaticItemHeight: false, onScroll: needHandleScroll ? throttledScrollHandler : undefined }, virtualListProps), function (child) { return child; }),
                    scrollLoadingEle)) : (react_1.default.createElement("div", { className: prefixCls + "-content", ref: refItemListWrapper },
                    listItems,
                    scrollLoadingEle)),
