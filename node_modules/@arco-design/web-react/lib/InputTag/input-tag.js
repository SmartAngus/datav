...
var UsedDraggableGroup = function (_a) {
    ...
    return draggable ? (react_1.default.createElement(Draggable_1.default, { itemWrapperStyle: { display: 'inline-block' }, direction: "horizontal", onIndexChange: onIndexChange }, children)) : (react_1.default.createElement(react_1.default.Fragment, null, children));
};
...
function InputTag(baseProps, ref) {
    ...
    return (react_1.default.createElement("div", __assign({}, (0, constant_1.pickTriggerPropsFromRest)(props), { style: style, className: (0, classNames_1.default)(prefixCls, (_a = {},
        ...
        react_1.default.createElement("div", { className: prefixCls + "-view" },
            react_1.default.createElement(UsedTransitionGroup, { prefixCls: prefixCls, animation: animation },
                react_1.default.createElement(UsedDraggableGroup, { draggable: draggable, onIndexChange: function (index, prevIndex) {
