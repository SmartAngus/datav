...
var TabHeader = react_1.default.forwardRef(function (props, ref) {
    ...
    var _e = __read((0, react_1.useState)(0), 2), headerOffset = _e[0], setHeaderOffset = _e[1];
    var _f = __read((0, react_1.useState)(true), 2), shouldScroll = _f[0], setShouldScroll = _f[1];
    var paneChildren = mergeProps.paneChildren, editable = mergeProps.editable, prefixCls = mergeProps.prefixCls, onAddTab = mergeProps.onAddTab, direction = mergeProps.direction, _g = mergeProps.type, type = _g === void 0 ? 'line' : _g, _h = mergeProps.overflow, overflow = _h === void 0 ? 'scroll' : _h, activeTab = mergeProps.activeTab, showAddButton = mergeProps.showAddButton, _j = mergeProps.size, size = _j === void 0 ? 'default' : _j, style = mergeProps.style, tabPosition = mergeProps.tabPosition, className = mergeProps.className, extra = mergeProps.extra, animation = mergeProps.animation, icons = mergeProps.icons, deleteButton = mergeProps.deleteButton, addButton = mergeProps.addButton, renderTabTitle = mergeProps.renderTabTitle, scrollAfterEdit = mergeProps.scrollAfterEdit, _k = mergeProps.scrollPosition, scrollPosition = _k === void 0 ? 'auto' : _k;
    ...
    var renderAddIcon = function (isEditable) {
        return (isEditable &&
            showAddButton && (react_1.default.createElement("div", { className: prefixCls + "-add-icon", onClick: handleAdd }, addButton || (react_1.default.createElement(icon_hover_1.default, { prefix: prefixCls + "-add" },
    ...
    return (react_1.default.createElement("div", { className: (0, classNames_1.default)(prefixCls + "-header-nav", prefixCls + "-header-nav-" + direction, prefixCls + "-header-nav-" + tabPosition, prefixCls + "-header-size-" + size, prefixCls + "-header-nav-" + type, className), style: style, ref: ref },
        react_1.default.createElement("div", { className: (0, classNames_1.default)(prefixCls + "-header-scroll", (_a = {},
                ...
                _a)) },
            isScroll && (react_1.default.createElement(tab_nav_icon_1.default, { iconPos: "prev", prefixCls: prefixCls, currentOffset: headerOffset, headerSize: headerSize, headerWrapperSize: headerWrapperSize, 
            ...
            isScroll && (react_1.default.createElement(tab_nav_icon_1.default, { prefixCls: prefixCls, currentOffset: headerOffset, headerSize: headerSize, headerWrapperSize: headerWrapperSize, direction: direction, align: align, onChange: updateHeaderOffset })),
            ...
            ((isEditable && isScrollable) || extra) && (react_1.default.createElement("div", { className: prefixCls + "-header-extra" },
                isScrollable && renderAddIcon(isEditable),
                extra)))));
});
