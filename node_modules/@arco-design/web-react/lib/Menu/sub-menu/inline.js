...
var SubMenuInline = function (props) {
    ...
    var _b = (0, react_1.useContext)(context_1.default), prefixCls = _b.prefixCls, levelIndent = _b.levelIndent, _c = _b.openKeys, openKeys = _c === void 0 ? [] : _c, _d = _b.selectedKeys, selectedKeys = _d === void 0 ? [] : _d, icons = _b.icons, onClickSubMenu = _b.onClickSubMenu, onClickMenuItem = _b.onClickMenuItem, collectInlineMenuKeys = _b.collectInlineMenuKeys;
    ...
    var header = (react_1.default.createElement("div", { className: (0, classNames_1.default)(baseClassName + "-header", (_a = {},
    ...
    var content = (react_1.default.createElement("div", { className: (0, classNames_1.default)(baseClassName + "-content"), style: { height: height } }, childrenList));
