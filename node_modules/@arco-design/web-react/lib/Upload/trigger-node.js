...
var TriggerNode = function (props) {
    ...
    return children === null ? null : (react_1.default.createElement("div", { className: prefixCls + "-trigger", onClick: disabled ? undefined : props.onClick, onDragEnter: function () {
        ...
        tip && react_1.default.createElement("div", { className: prefixCls + "-trigger-tip" }, tip))) : drag ? (react_1.default.createElement("div", { className: (0, classNames_1.default)(prefixCls + "-trigger-drag", (_b = {},
