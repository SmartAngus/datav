...
function InputNumber(baseProps, ref) {
    ...
    return (react_1.default.createElement(Input_1.default, __assign({}, rest, inputEventHandlers, { style: style, className: (0, classNames_1.default)(prefixCls, prefixCls + "-mode-" + mode, prefixCls + "-size-" + mergedSize, (_a = {},
