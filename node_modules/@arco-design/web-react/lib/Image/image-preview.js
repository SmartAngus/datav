...
function Preview(props, ref) {
    ...
    var _j = (0, react_1.useContext)(previewGroupContext_1.PreviewGroupContext), previewGroup = _j.previewGroup, previewUrlMap = _j.previewUrlMap, currentId = _j.currentId, setCurrentId = _j.setCurrentId, infinite = _j.infinite;
    ...
    var _k = __read((0, useMergeValue_1.default)(false, {
        defaultValue: defaultVisible,
        value: props.visible,
    }), 2), visible = _k[0], setVisible = _k[1];
    var _l = (0, react_1.useContext)(ConfigProvider_1.ConfigContext), getPrefixCls = _l.getPrefixCls, locale = _l.locale;
    ...
    var _m = (0, useImageStatus_1.default)('loading'), isLoading = _m.isLoading, isLoaded = _m.isLoaded, setStatus = _m.setStatus;
    var _o = __read((0, react_1.useState)(false), 2), toolbarSimple = _o[0], setToolbarSimple = _o[1];
    var _p = __read((0, react_1.useState)({ x: 0, y: 0 }), 2), translate = _p[0], setTranslate = _p[1];
    var _q = __read((0, react_1.useState)(1), 2), scale = _q[0], setScale = _q[1];
    var _r = __read((0, react_1.useState)(false), 2), scaleValueVisible = _r[0], setScaleValueVisible = _r[1];
    var _s = __read((0, react_1.useState)(0), 2), rotate = _s[0], setRotate = _s[1];
    var _t = __read((0, react_1.useState)(false), 2), moving = _t[0], setMoving = _t[1];
    // Reset image params
    function reset() {
    ...
    var _u = __read((0, react_1.useState)(), 2), container = _u[0], setContainer = _u[1];
