...
function Cascader(baseProps, ref) {
    ...
    var store = (0, useRefCurrent_1.default)(function () { return getStore(props, mergeValue); }, [JSON.stringify(getConfig(props)), props.options]);
