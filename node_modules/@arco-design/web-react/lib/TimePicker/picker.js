...
var Picker = function (baseProps) {
    var _a = (0, react_1.useContext)(ConfigProvider_1.ConfigContext), locale = _a.locale, getPrefixCls = _a.getPrefixCls, componentConfig = _a.componentConfig;
    ...
    function isValidTime(time) {
        return typeof time === 'string' && (0, dayjs_1.dayjs)(time, format).format(format) === time;
    }
    function onConfirmValue(vs) {
        var newValue = isRangePicker && order ? (0, dayjs_1.getSortedDayjsArray)(vs) : vs;
        setValue(newValue);
        setValueShow(undefined);
        setInputValue(undefined);
    ...
    function confirmInputValue(newInputValue) {
        if (isRangePicker) {
            ...
            if (isValidTime(newInputValue)) {
                newValueShow[focusedInputIndex] = (0, dayjs_1.getDayjsValue)(newInputValue, format);
                setValueShow(newValueShow);
                setInputValue(undefined);
            }
        }
        else if (isValidTime(newInputValue)) {
            setValueShow((0, dayjs_1.getDayjsValue)(newInputValue, format));
            setInputValue(undefined);
        }
    }
