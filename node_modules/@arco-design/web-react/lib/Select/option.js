...
function Option(props, ref) {
    ...
    if (isMultipleMode) {
        return (react_1.default.createElement("li", { ref: ref, className: (0, classNames_1.default)(prefixCls + "-option-wrapper", (_b = {},
                _b[prefixCls + "-option-wrapper-selected"] = isChecked,
                _b[prefixCls + "-option-wrapper-disabled"] = disabled,
                _b), wrapperClassName) },
            react_1.default.createElement(Checkbox_1.default, { className: prefixCls + "-checkbox", checked: isChecked, disabled: disabled, onChange: optionLabelProps.onClick }),
            react_1.default.createElement("span", __assign({}, optionLabelProps), children)));
    }
    return (react_1.default.createElement("li", __assign({ ref: ref }, optionLabelProps), children));
}
