...
function Select(baseProps, ref) {
    ...
    var _e = __read((0, react_1.useState)([]), 2), userCreatedOptions = _e[0], setUserCreatedOptions = _e[1];
    // 具有选中态或者 hover 态的 option 的 value
    var _f = __read((0, react_1.useState)((0, is_1.isArray)(value) ? value[0] : value), 2), valueActive = _f[0], setValueActive = _f[1];
    ...
    var getValueForCallbackParameter = function (value, option, isEmpty) {
        var _a;
        if (isEmpty === void 0) { isEmpty = (0, utils_1.isEmptyValue)(value, isMultipleMode); }
        if (labelInValue && !isEmpty) {
            if (Array.isArray(value)) {
                return value.map(function (optionValue, index) {
                    var _a;
                    return ({
                        value: optionValue,
            ...
            return { value: value, label: (_a = option) === null || _a === void 0 ? void 0 : _a.children };
        }
        return value;
    };
    ...
    var renderPopup = function () {
        ...
        var eleOptionList = childrenList.length ? (react_1.default.createElement(VirtualList_1.default, __assign({ style: dropdownMenuStyle, className: (0, classNames_1.default)(prefixCls + "-popup-inner", dropdownMenuClassName), ref: refWrapper, data: childrenList, height: null, isStaticItemHeight: !hasOptGroup, measureLongestItem: needMeasureLongestItem, itemKey: function (child) { return child.props._key; }, onMouseDown: utils_1.preventDefaultEvent, onMouseMove: function () {
            ...
            if ((0, utils_1.isSelectOption)(child)) {
                return (child && (react_1.default.createElement(child.type, __assign({}, child.props, { prefixCls: prefixCls, valueSelect: value, valueActive: valueActive, isMultipleMode: isMultipleMode, onClickOption: handleOptionClick, onMouseEnter: function (value) {
        ...
        // 无选项时的占位符元素
        var eleNoOptionPlaceholder = mergedNotFoundContent ? (react_1.default.createElement("div", { style: dropdownMenuStyle, className: (0, classNames_1.default)(prefixCls + "-popup-inner", dropdownMenuClassName) }, mergedNotFoundContent)) : null;
    ...
    return (react_1.default.createElement(resizeObserver_1.default, { onResize: function () { return refTrigger.current.updatePopupPosition(); } },
        react_1.default.createElement(Trigger_1.default, __assign({ ref: function (ref) { return (refTrigger.current = ref); }, popup: renderPopup, trigger: trigger, disabled: disabled, getPopupContainer: getPopupContainer, classNames: "slideDynamicOrigin", autoAlignPopupWidth: true, popupAlign: { bottom: 4 }, popupVisible: popupVisible, unmountOnExit: unmountOnExit, onVisibleChange: tryUpdatePopupVisible }, (0, omit_1.default)(triggerProps, ['popupVisible', 'onVisibleChange'])), triggerElement || (react_1.default.createElement(select_view_1.default, __assign({}, props, selectViewEventHandlers, { ref: refSelectView, 
            ...
            // other
            prefixCls: prefixCls, isEmptyValue: isNoOptionSelected, isMultiple: isMultipleMode, onSort: tryUpdateSelectValue, renderText: function (value) {
                var option = getOptionInfoByValue(value);
                var text = value;
                if ((0, is_1.isFunction)(renderFormat)) {
                    text = renderFormat(option || null, getValueForCallbackParameter(value, option));
                }
                else if (option) {
