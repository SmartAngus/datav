...
var Scroll = /** @class */ (function () {
    function Scroll(parent) {
        ...
        this.onMouseMove = function (e) {
            if (_this.isDownH) {
                ...
                _this.h.style.left = "".concat(_this.scrollX, "px");
                _this.parent.data.x = _this.x - (x * _this.rect.width) / _this.parent.parentElem.clientWidth;
            }
            if (_this.isDownV) {
                var y = e.y - _this.isDownV;
                _this.scrollY = _this.lastScrollY + y;
                _this.v.style.top = "".concat(_this.scrollY, "px");
                _this.parent.data.y = _this.y - (y * _this.rect.height) / _this.parent.parentElem.clientHeight;
            }
            if (_this.isDownH || _this.isDownV) {
                _this.parent.render();
                _this.parent.divLayer.render();
            }
        };
        this.onMouseUp = function (e) {
            ...
            else if (_this.scrollX > _this.parent.parentElem.clientWidth - _this.hSize - 20) {
                _this.scrollX = _this.parent.parentElem.clientWidth - _this.hSize - 20;
                _this.h.style.left = "".concat(_this.scrollX, "px");
            }
            if (_this.scrollY < 20) {
                _this.scrollY = 20;
            ...
            else if (_this.scrollY > _this.parent.parentElem.clientHeight - _this.vSize - 20) {
                _this.scrollY = _this.parent.parentElem.clientHeight - _this.vSize - 20;
                _this.v.style.top = "".concat(_this.scrollY, "px");
            }
            _this.resize();
        };
    ...
    Scroll.prototype.initPos = function () {
        ...
        this.h.style.left = "".concat(this.scrollX, "px");
        this.v.style.top = "".concat(this.scrollY, "px");
    };
